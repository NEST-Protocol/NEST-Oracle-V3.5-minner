...
import com.nest.ib.contract.NestPoolContract;
...
public class Erc20State {
    ...
    public boolean updateErc20State(String tokenAddress,
        ...
        try {
            ...
            NestPoolContract nestPoolContract = ContractBuilder.nestPoolContractReadonly(Web3jHelper.getWeb3j());
            String nTokenAddress = nestPoolContract.getNTokenFromToken(tokenAddress).send();
